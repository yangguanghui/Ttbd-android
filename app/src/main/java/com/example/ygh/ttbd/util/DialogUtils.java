...
public class DialogUtils
{
     ...
     * @param positiveBtnListener 监听器，需实现android.content.DialogInterface
     *                            .OnClickListener接口 必填
     * @param negativeBtnListener 监听器，需实现android.content.DialogInterface
     *                            .OnClickListener接口 必填
    ...
    public static Dialog createSingleChoiceDialog(Context context,
                                                  String title, String[] itemsString,
